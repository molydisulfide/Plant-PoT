...
const int wet = 292; // value on cap sensor when it is fully wet.
const int dry = 531; // value on cap sensor when it is fully dry.
...
void displayMoisture() {       
    ...
    Serial.print(percentageHumidity); Serial.println("%");
    
    if(percentageHumidity < 10) {
      
      Serial.print("Signal has tripped at "); Serial.print(percentageHumidity); Serial.println(" cap percentage."); 
